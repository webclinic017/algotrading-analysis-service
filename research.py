...
def research():
    ...
    analysis_duration_backward = "40 days"
...
#         fin="/config/workspace/algotrading-analysis-service/StudyZone/results/318796-2022-06-29__3:04PM-BANKNIFTY-FUT-5months.csv",
#         df=pd.DataFrame(),
#         fout="test-out",
#     )
# )
